...
<body>
    <h1>&nbsp;Public Assets for Edmonton Neighbourhoods.</h1>
    <br/>
    <p>
        &nbsp;This website is not ready for general use!
        We are building up a list of public assets that anyone can take advantage of.<br/>
    ...
    <br/>
    <p>
        &nbsp;We have ${assetCount} assets on file (not counting 'inactive' assets).<br/>
